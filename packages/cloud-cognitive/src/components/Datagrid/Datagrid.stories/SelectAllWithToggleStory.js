...
- Pagination
  ...
  - **Server side pagination**: subtset of rows are loaded to browser, going to another page requires another network call
- Selection mode
...
- Obvisouly it will not work when select-all is hidden by \`options.hideSelectAll\`.
...
- (optional) \`options.selectAllToggle.onSelectAllRows\`
  ...
  - callback when \`instance.isAllRowsSelected\` value changes. Check out doc: [instace property](https://react-table.tanstack.com/docs/api/useRowSelect#instance-properties)
