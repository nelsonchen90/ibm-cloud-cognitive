...
const notes = `
  # Customizing columns
  Customizing columns allows user to reorder and hide certain columns of the datagrid. Consuming component can use the provided callback to save/update according to their persisitent strategy.
  ...
  - (required) Implement \`options.DatagridActions\` component
    ...
    - \`CustomizeColumnsButton\` props can be overriden. Available props: [carbon-components-react doc](https://react.carbondesignsystem.com/?path=/docs/components-button--default)
