...
const Columns = ({
  ...
  disabledInstructionsLabel = 'Reordering columns are disabled because they are filetered currently.',
}) => {
  ...
  return (
    <div className="datagrid-customize-columns-column-list">
      <DndProvider backend={HTML5Backend}>
        <ol
          className="datagrid-customize-columns-column-list--focus"
          role="listbox"
          aria-describedby="datagrid-customize-columns--instructions"
          onKeyDown={(e) => {
        ...
        >
          <span aria-live="assertive" className="wkc-shared-ui--assitive-text">
            {ariaRegionText}
          </span>
          <span
            id="datagrid-customize-columns--instructions"
            className="wkc-shared-ui--assitive-text"
          >
          ...
          {
            columns
              .filter((colDef) => filterString.length === 0
              ...
              .map((colDef, i) => (
                ...
                >
                  <Checkbox
                    wrapperClassName="datagrid-customize-columns-checkbox"
                    checked={isColumnVisible(colDef)}
                    onChange={onSelectColumn.bind(null, colDef)}
                    id={`datagrid-customization-column-${colDef.id}`}
